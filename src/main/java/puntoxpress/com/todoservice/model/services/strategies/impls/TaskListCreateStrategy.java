...
public class TaskListCreateStrategy extends AbstractStrategy<TaskList, TaskListDto> implements Strategy<TaskList, TaskListDto> {
    ...
    public void perform(Wrapper<TaskList, TaskListDto> wrapper) throws Exception {
        ...
        TaskList taskList = taskListMapper.taskListDtoToTaskList(wrapper.getRequest().getData());
        taskList.setUser(user);

        TaskList entity = repository.save(taskList);

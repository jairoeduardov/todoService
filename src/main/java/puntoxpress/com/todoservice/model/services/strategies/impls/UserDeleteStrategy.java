...
public class UserDeleteStrategy  extends AbstractStrategy<User, UserDto> implements Strategy<User, UserDto> {
    ...
    public void perform(Wrapper<User, UserDto> wrapper) throws Exception {
       ...
       //createResponse(wrapper, UserMapper.INSTANCE.tagToUserDto(entity));
    }
}
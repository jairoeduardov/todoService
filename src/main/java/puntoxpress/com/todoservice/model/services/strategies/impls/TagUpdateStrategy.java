...
public class TagUpdateStrategy  extends AbstractStrategy<Tag, TagDto> implements Strategy<Tag, TagDto> {

    private final TagRepository repository;

    @Override
    public void perform(Wrapper<Tag, TagDto> wrapper) throws Exception {
        TagMapper.INSTANCE.updateTagFromDto(wrapper.getRequest().getData(), wrapper.getEntity());

...
public class TaskRetrieveByTaskListUuid extends AbstractStrategy<Task, TaskDto> implements Strategy<Task, TaskDto> {

    private final TaskRepository repository;

    @Override
    public void perform(Wrapper<Task, TaskDto> wrapper) throws Exception {
        List<Task> entities = repository.findByTaskListUuid(wrapper.getUuid());

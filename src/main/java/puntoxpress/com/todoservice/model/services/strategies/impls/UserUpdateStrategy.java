...
public class UserUpdateStrategy  extends AbstractStrategy<User, UserDto> implements Strategy<User, UserDto> {

    private final UserRepository repository;

    @Override
    public void perform(Wrapper<User, UserDto> wrapper) throws Exception {
        UserMapper.INSTANCE.updateUserFromDto(wrapper.getRequest().getData(), wrapper.getEntity());

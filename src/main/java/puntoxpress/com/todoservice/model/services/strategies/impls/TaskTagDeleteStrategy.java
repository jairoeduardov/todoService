...
public class TaskTagDeleteStrategy  extends AbstractStrategy<TaskTag, TaskTagDto> implements Strategy<TaskTag, TaskTagDto> {
    ...
    public void perform(Wrapper<TaskTag, TaskTagDto> wrapper) throws Exception {
       ...
       //createResponse(wrapper, TaskTagMapper.INSTANCE.tagToTaskTagDto(entity));
    }
}